# aws/cognito_auth live suite

Provider-backed coverage for `modules/aws/cognito_auth`.
...
- applies the shared `aws/cognito_auth` module
...
- `COGNITO_AUTH_TEST_BASE_DOMAIN` and `COGNITO_AUTH_TEST_ROUTE53_ZONE_ID`
